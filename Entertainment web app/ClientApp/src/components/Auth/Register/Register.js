        ...
        <section className="register">
            ...
            <div className="register__container">
                <form className="form" onSubmit={handleSubmit}>
                    ...
                    {isSuccess && isSubmitted && <p className="form__success">Account created successfully!<br />{message}</p>}
                    {!isSuccess && isSubmitted && <p className="form__error">There is some problem, user not registered!<br/>{message}</p>}
